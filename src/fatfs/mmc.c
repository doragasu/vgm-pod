...
/* Modified by Jesús Alonso (doragasu)                                   */
/*-----------------------------------------------------------------------*/
...
/*
 * Modified by Jesús Alonso (doragasu) from a sample available from the
 * FatFs web site. It was modified to work with a Stellaris Launchpad
 * evaluation board.
 */
...
#define SELECT() \
    do{MAP_GPIOPinWrite(SDC_GPIO_PORT_BASE, SDC_SSI_FSS, 0);}while(0)
// de-asserts the CS pin to the card
#define DESELECT() \
    do{MAP_GPIOPinWrite(SDC_GPIO_PORT_BASE, SDC_SSI_FSS, SDC_SSI_FSS);}while(0)
/*--------------------------------------------------------------------------
...
void xmit_spi(BYTE dat)
{
    ...
    MAP_SSIDataGet(SDC_SSI_BASE, &rcvdat); /* flush data read during the write */
}
...
BYTE rcvr_spi (void)
{
    ...
    MAP_SSIDataGet(SDC_SSI_BASE, &rcvdat); /* read data frm rx fifo */
...
void send_initial_clock_train(void)
{
    ...
    MAP_GPIOPinTypeGPIOOutput(SDC_GPIO_PORT_BASE, SDC_SSI_TX);
    MAP_GPIOPinWrite(SDC_GPIO_PORT_BASE, SDC_SSI_TX, SDC_SSI_TX);
    ...
    for(i = 0 ; i < 10 ; i++)
    {
        ...
        MAP_SSIDataGet(SDC_SSI_BASE, &dat);
    }

    /* Revert to hardware control of the SSI TX line. */
    MAP_GPIOPinTypeSSI(SDC_GPIO_PORT_BASE, SDC_SSI_TX);
}
...
void power_on (void)
{
    ...
    MAP_SSIConfigSetExpClk(SDC_SSI_BASE, MAP_SysCtlClockGet(),
